...
function WhatsAppIcon({ size = 19, className = "" }: { size?: number; className?: string }) {
  return (
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-green-100 bg-green-50 transition-colors group-hover:bg-green-100">
                  <WhatsAppIcon size={19} className="text-green-600" />
                </div>
                <div>
          ...
          <div>
            {sent ? (
              ...
              >
                ...
                >
                  <WhatsAppIcon size={19} className="shrink-0 text-green-600" />
